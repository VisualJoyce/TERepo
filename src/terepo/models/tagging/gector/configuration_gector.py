...
class GECToRConfig(PretrainedConfig):
    ...
    def __init__(self,
                 ...
                 label_vocab_size=0,
                 focal_gamma=2,
                 use_matching_dropout=False,
                 use_matching_layernorm=False,
        ...
        assert (
                "encoder" in kwargs
        ), "Config has to be initialized with encoder config"
        ...
        self.detect_vocab_size = detect_vocab_size
        self.label_vocab_size = label_vocab_size

        self.focal_gamma = focal_gamma
        self.use_matching_dropout = use_matching_dropout
        self.use_matching_layernorm = use_matching_layernorm
